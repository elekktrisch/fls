...
ALTER TABLE aircraft
    ...
    ADD CONSTRAINT fk_aircraft_managing_club_id
        FOREIGN KEY (managing_club_id) REFERENCES club (id) ON DELETE RESTRICT;

CREATE INDEX ix_aircraft_managing_club ON aircraft (managing_club_id);

COMMENT ON COLUMN aircraft.managing_club_id IS
