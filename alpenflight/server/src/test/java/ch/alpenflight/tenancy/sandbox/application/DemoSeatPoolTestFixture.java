...
public final class DemoSeatPoolTestFixture {

    private DemoSeatPoolTestFixture() {
    }

    public static void returnEverySeatToThePool(DemoSeatRepository seats,
    ...
    public static DemoSeat seatNumbered(DemoSeatRepository seats, int seatNumber) {
