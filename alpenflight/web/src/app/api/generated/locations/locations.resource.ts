 ...
 */
export function getLocationResource(id: Signal<string>,
...
export function getLocationResource(id: Signal<string>,
  options?: OrvalHttpResourceOptions<LocationDetail, unknown>): HttpResourceRef<LocationDetail | undefined> {
  return httpResource<LocationDetail>(() => `/api/v1/locations/${id()}`, options);
}

/**
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function listLocationsResource(options: OrvalHttpResourceOptions<LocationListItem[], unknown> & { defaultValue: NoInfer<LocationListItem[]> }): HttpResourceRef<LocationListItem[]>;
export function listLocationsResource(options?: OrvalHttpResourceOptions<LocationListItem[], unknown>): HttpResourceRef<LocationListItem[] | undefined>;
export function listLocationsResource(options?: OrvalHttpResourceOptions<LocationListItem[], unknown>): HttpResourceRef<LocationListItem[] | undefined> {
  return httpResource<LocationListItem[]>(() => `/api/v1/locations`, options);
}

export type GetLocationResourceResult = NonNullable<LocationDetail>
export type ListLocationsResourceResult = NonNullable<LocationListItem[]>
