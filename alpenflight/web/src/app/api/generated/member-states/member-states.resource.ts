 ...
 */
export function listMemberStatesResource(options: OrvalHttpResourceOptions<MemberStateListItem[], unknown> & { defaultValue: NoInfer<MemberStateListItem[]> }): HttpResourceRef<MemberStateListItem[]>;
export function listMemberStatesResource(options?: OrvalHttpResourceOptions<MemberStateListItem[], unknown>): HttpResourceRef<MemberStateListItem[] | undefined>;
export function listMemberStatesResource(options?: OrvalHttpResourceOptions<MemberStateListItem[], unknown>): HttpResourceRef<MemberStateListItem[] | undefined> {
  return httpResource<MemberStateListItem[]>(() => `/api/v1/club/member-states`, options);
}

export type ListMemberStatesResourceResult = NonNullable<MemberStateListItem[]>
