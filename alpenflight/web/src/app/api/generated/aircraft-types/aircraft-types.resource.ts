 ...
 */
export function listAircraftTypesResource(options: OrvalHttpResourceOptions<AircraftTypeResponse[], unknown> & { defaultValue: NoInfer<AircraftTypeResponse[]> }): HttpResourceRef<AircraftTypeResponse[]>;
export function listAircraftTypesResource(options?: OrvalHttpResourceOptions<AircraftTypeResponse[], unknown>): HttpResourceRef<AircraftTypeResponse[] | undefined>;
export function listAircraftTypesResource(options?: OrvalHttpResourceOptions<AircraftTypeResponse[], unknown>): HttpResourceRef<AircraftTypeResponse[] | undefined> {
  return httpResource<AircraftTypeResponse[]>(() => `/api/v1/aircraft-types`, options);
}

export type ListAircraftTypesResourceResult = NonNullable<AircraftTypeResponse[]>
