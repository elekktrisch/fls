 ...
 */
export function listCounterUnitTypesResource(options: OrvalHttpResourceOptions<CounterUnitTypeResponse[], unknown> & { defaultValue: NoInfer<CounterUnitTypeResponse[]> }): HttpResourceRef<CounterUnitTypeResponse[]>;
export function listCounterUnitTypesResource(options?: OrvalHttpResourceOptions<CounterUnitTypeResponse[], unknown>): HttpResourceRef<CounterUnitTypeResponse[] | undefined>;
export function listCounterUnitTypesResource(options?: OrvalHttpResourceOptions<CounterUnitTypeResponse[], unknown>): HttpResourceRef<CounterUnitTypeResponse[] | undefined> {
  return httpResource<CounterUnitTypeResponse[]>(() => `/api/v1/counter-unit-types`, options);
}

export type ListCounterUnitTypesResourceResult = NonNullable<CounterUnitTypeResponse[]>
