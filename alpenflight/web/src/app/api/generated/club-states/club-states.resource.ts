 ...
 */
export function listClubStatesResource(options: OrvalHttpResourceOptions<ClubStateResponse[], unknown> & { defaultValue: NoInfer<ClubStateResponse[]> }): HttpResourceRef<ClubStateResponse[]>;
export function listClubStatesResource(options?: OrvalHttpResourceOptions<ClubStateResponse[], unknown>): HttpResourceRef<ClubStateResponse[] | undefined>;
export function listClubStatesResource(options?: OrvalHttpResourceOptions<ClubStateResponse[], unknown>): HttpResourceRef<ClubStateResponse[] | undefined> {
  return httpResource<ClubStateResponse[]>(() => `/api/v1/club-states`, options);
}

export type ListClubStatesResourceResult = NonNullable<ClubStateResponse[]>
