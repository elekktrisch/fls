 ...
 */
export function listLocationTypesResource(options: OrvalHttpResourceOptions<LocationTypeResponse[], unknown> & { defaultValue: NoInfer<LocationTypeResponse[]> }): HttpResourceRef<LocationTypeResponse[]>;
export function listLocationTypesResource(options?: OrvalHttpResourceOptions<LocationTypeResponse[], unknown>): HttpResourceRef<LocationTypeResponse[] | undefined>;
export function listLocationTypesResource(options?: OrvalHttpResourceOptions<LocationTypeResponse[], unknown>): HttpResourceRef<LocationTypeResponse[] | undefined> {
  return httpResource<LocationTypeResponse[]>(() => `/api/v1/location-types`, options);
}

export type ListLocationTypesResourceResult = NonNullable<LocationTypeResponse[]>
