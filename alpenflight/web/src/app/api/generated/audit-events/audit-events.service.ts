 ...
 */
 listAuditEvents<TData = AuditEventPage>(params?: ListAuditEventsParams, options?: HttpClientBodyOptions): Observable<TData>;
 listAuditEvents<TData = AuditEventPage>(params?: ListAuditEventsParams, options?: HttpClientEventOptions): Observable<HttpEvent<TData>>;
 listAuditEvents<TData = AuditEventPage>(params?: ListAuditEventsParams, options?: HttpClientResponseOptions): Observable<AngularHttpResponse<TData>>;
  listAuditEvents<TData = AuditEventPage>(
    params?: ListAuditEventsParams, options?: HttpClientObserveOptions): Observable<TData | HttpEvent<TData> | AngularHttpResponse<TData>> {
