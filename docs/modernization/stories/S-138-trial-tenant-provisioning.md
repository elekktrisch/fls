...
- **Schema deviation from ADR 0022 D2: none.** Lifecycle transitions live on `DeploymentLifecycleStateMachine` (S-137); the new partial UNIQUE is structural identity uniqueness, not business logic.
