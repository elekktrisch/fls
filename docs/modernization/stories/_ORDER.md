...
|---|---|---|---|---|---|---|
| J-33 🔨 | Audit attribution + the migrate dead-end — drain every S1/S2 rider (**hardening**) | E-13 | — | — (rider burndown) | mapper-touching (`AuditLogMapper` FK columns) | none — reuses `/system/logs` + `/migrate/start` |
