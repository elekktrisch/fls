...
- S-062 — L — Flight create/edit (deps S-058, S-059, S-060)
- S-063 — M — Glider↔Tow link integrity (deps S-062)
- S-064 — M — Air movements (motor aircraft) (deps S-062)
- S-067 — M — Optimistic-concurrency on Flight (deps S-058)
- S-065 — L — Flight reports + custom report builder (deps S-062, S-093)
...
- S-110 — S — T3-equivalent smoke (deps S-020, S-021, S-062)
