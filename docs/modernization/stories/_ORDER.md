...
J-6b (#213), J-24 (#192), J-25 (#196). **Carved + in flight:** **J-7**
(Flight reports + Excel export — the read-side payoff of the J-2 flight data + the first
synchronous Excel export, which homes the POI export infra + cell-parity harness;
carved 2026-06-09 onto `integration/J-7` off `origin/main`). All other unmarked rows are `todo`.
