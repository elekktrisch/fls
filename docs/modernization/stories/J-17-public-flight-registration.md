...
- [ ] **T-13b** — Scenic public endpoint: `POST` registration + DTO reusing T-13a's shared registrant payload, `@Operation(operationId=…)`, `201` + `Location`. No day selection. *(seam: scenic controller)*
