...
- [ ] **T-15b** — Club-admin edit page: operator-email fields + the discovery-day management panel. **Club PUT is full-replace** — the form must submit all three new fields or a save silently clears them. *(seam: web features/clubs/edit)*
