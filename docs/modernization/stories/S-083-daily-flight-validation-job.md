...
epic: E-10
status: todo
depends_on: [S-081, S-059, S-061, S-038]
acceptance:
  - The job runs nightly (cron in UTC; equivalent local time documented).
  - Validates `NotProcessed`/`Invalid` flights → `Valid` or `Invalid` per validation rules (S-062 ports them).
...
- [ ] Reuse validation rules from S-062 and time gates from S-061.
