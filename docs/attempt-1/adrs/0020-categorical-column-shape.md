...
- **Follow-ups (other ADRs / stories implied):**
  ...
  - **Convention entry**: add a `## Column shape` section to `alpenflight/server/CONVENTIONS.md` (first authored by S-012) summarising the decision rule + linking back here. Future schema PRs cite this conventions section.
