...
public final class SharedPostgresContainer {
     ...
     * class references this method via {@code @EnabledIf("ch.fls.server.testsupport.SharedPostgresContainer#available")}
    ...
    private static boolean tryStart() {
        try {
            ...
            System.err.println("""
                    [fls-server] Skipping DB-dependent tests — Docker unreachable.
                      Root cause: %s
